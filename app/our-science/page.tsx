      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex h-24 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 md:flex">
            ...
            <a href="/our-science" className="text-sm text-white transition-colors">Our Science</a>
      ...
      {open && (
        <div className="border-t border-white/[0.08] bg-[#0E1A2B] px-4 py-4 md:hidden">
          <div className="flex flex-col gap-1">
            ...
            <a
              href="/our-science"
              className="rounded-lg px-3 py-2.5 text-sm text-white transition-colors hover:bg-white/5"
              onClick={() => setOpen(false)}
            >
              Our Science
            </a>
        ...
        <div className="flex flex-col items-center justify-between gap-6 text-center sm:flex-row sm:items-start sm:text-left">
          <div className="flex flex-col gap-3">
            ...
            <span className="text-sm text-slate-400">
              &copy; {new Date().getFullYear()} Rebel Minds Ops. All rights reserved.
            </span>
          </div>
