      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex h-24 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 md:flex">
            ...
            <a href="/cybersecurity" className="inline-flex items-center gap-1.5 text-sm text-white transition-colors">
              Cybersecurity
      ...
      {open && (
        <div className="border-t border-white/[0.08] bg-[#0E1A2B] px-4 py-4 md:hidden">
          <div className="flex flex-col gap-1">
            ...
            <a
              href="/cybersecurity"
              className="flex items-center gap-1.5 rounded-lg px-3 py-2.5 text-sm text-white transition-colors hover:bg-white/5"
              onClick={() => setOpen(false)}
            >
              Cybersecurity
              <span className="rounded-full bg-[#7DE3E6]/15 px-1.5 py-0.5 text-[10px] font-semibold leading-none text-[#7DE3E6]">New</span>
