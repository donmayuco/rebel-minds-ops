        ...
        <div className="flex h-24 items-center justify-between">
          ...
          <div className="hidden items-center gap-6 md:flex">
            ...
            >
              ...
              {servicesOpen && (
                <div className="absolute left-1/2 top-full z-50 mt-2 -translate-x-1/2 rounded-xl border border-white/[0.08] bg-[#0B1220] p-1.5 shadow-xl backdrop-blur-md" style={{ minWidth: 220 }}>
                  ...
                  <a href="#cyber-intake" className="block rounded-lg px-3.5 py-2.5 text-sm text-slate-300 transition-colors hover:bg-white/5 hover:text-white">
          ...
          <div className="flex flex-col gap-1">
            ...
            {mobileServicesOpen && (
              <div className="flex flex-col gap-0.5 pl-4">
                ...
                <a href="#cyber-intake" className="rounded-lg px-3 py-2 text-sm text-slate-400 transition-colors hover:bg-white/5 hover:text-white" onClick={() => setOpen(false)}>
                  Free Security Assessment
                </a>
              </div>
            )}
