 ...
 */
export default function WiringDiagram({ hero = false }: { hero?: boolean }) {
  ...
  return (
    <div
      className={hero ? undefined : "border-t"}
      style={hero ? undefined : { borderColor: "rgba(233,237,244,0.10)" }}
    >
      {!hero && (
      ...
      >
        ...
        >
          ...
          <g opacity="0.32">
            <path d="M 130 46 C 60 46, 40 30, -10 24" stroke="#8fa0b3" fill="none" strokeWidth="1" />
            <rect x="130" y="26" width="104" height="40" rx="5" fill="#141d2c" stroke="rgba(233,237,244,0.2)" />
            <text x="182" y="50" textAnchor="middle" fill="#8fa0b3" fontSize="12" fontFamily="var(--font-inter), sans-serif">Twilio</text>

            <path d="M 986 306 C 1060 306, 1080 320, 1130 326" stroke="#8fa0b3" fill="none" strokeWidth="1" />
            <rect x="882" y="286" width="104" height="40" rx="5" fill="#141d2c" stroke="rgba(233,237,244,0.2)" />
            <text x="934" y="310" textAnchor="middle" fill="#8fa0b3" fontSize="12" fontFamily="var(--font-inter), sans-serif">Stripe</text>

            <path d="M 312 384 C 312 400, 312 405, 312 420" stroke="#8fa0b3" fill="none" strokeWidth="1" />
            <rect x="260" y="344" width="104" height="40" rx="5" fill="#141d2c" stroke="rgba(233,237,244,0.2)" />
            <text x="312" y="368" textAnchor="middle" fill="#8fa0b3" fontSize="12" fontFamily="var(--font-inter), sans-serif">Zoho</text>

            <path d="M 1000 46 C 1060 46, 1080 40, 1130 34" stroke="#8fa0b3" fill="none" strokeWidth="1" />
            <rect x="896" y="26" width="104" height="40" rx="5" fill="#141d2c" stroke="rgba(233,237,244,0.2)" />
            <text x="948" y="50" textAnchor="middle" fill="#8fa0b3" fontSize="12" fontFamily="var(--font-inter), sans-serif">Supabase</text>

            <path d="M -10 300 C 40 300, 60 296, 100 290" stroke="#8fa0b3" fill="none" strokeWidth="1" />
            <path d="M 1130 160 C 1090 160, 1075 164, 1040 168" stroke="#8fa0b3" fill="none" strokeWidth="1" />
          </g>
          ...
          <g>
            ...
            <rect x="50" y="178" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(233,237,244,0.18)">
              {visible && <animate attributeName="stroke" begin="pk1.begin" dur="0.8s" values="rgba(233,237,244,0.18);#7fd7e2;rgba(233,237,244,0.18)" keyTimes="0;0.3;1" />}
            </rect>
            <circle cx="70" cy="198" r="3.5" fill="#25D366" />
            <text x="84" y="203" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">WhatsApp</text>
            <text x="70" y="221" fill="#8fa0b3" fontSize="9">FROM THE CREW&rsquo;S POCKET</text>
          </g>
          {/* n8n */}
          <g>
            ...
            <rect x="330" y="178" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(127,215,226,0.45)">
            ...
            <text x="364" y="203" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">n8n</text>
            <text x="350" y="221" fill="#8fa0b3" fontSize="9">ORCHESTRATION</text>
          </g>
          {/* OpenAI */}
          <g>
            ...
            <rect x="588" y="65" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(233,237,244,0.18)">
              {visible && <animate attributeName="stroke" begin="pk2.end" dur="0.8s" values="rgba(233,237,244,0.18);#7fd7e2;rgba(233,237,244,0.18)" keyTimes="0;0.3;1" />}
            </rect>
            <circle cx="608" cy="85" r="3.5" fill="#10A37F" />
            <text x="622" y="90" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">OpenAI</text>
            <text x="608" y="108" fill="#8fa0b3" fontSize="9">READS THE RECEIPT</text>
          </g>
          {/* Airtable */}
          <g>
            ...
            <rect x="588" y="178" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(233,237,244,0.18)">
              {visible && <animate attributeName="stroke" begin="pk3.end" dur="0.8s" values="rgba(233,237,244,0.18);#7fd7e2;rgba(233,237,244,0.18)" keyTimes="0;0.3;1" />}
            </rect>
            <circle cx="608" cy="198" r="3.5" fill="#FCB400" />
            <text x="622" y="203" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">Airtable</text>
            <text x="608" y="221" fill="#8fa0b3" fontSize="9">OWNER&rsquo;S DASHBOARD</text>
          </g>
          {/* QuickBooks */}
          <g>
            ...
            <rect x="588" y="291" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(233,237,244,0.18)">
              {visible && <animate attributeName="stroke" begin="pk3.end" dur="0.8s" values="rgba(233,237,244,0.18);#7fd7e2;rgba(233,237,244,0.18)" keyTimes="0;0.3;1" />}
            </rect>
            <circle cx="608" cy="311" r="3.5" fill="#2CA01C" />
            <text x="622" y="316" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">QuickBooks</text>
            <text x="608" y="334" fill="#8fa0b3" fontSize="9">BOOKS THAT RECONCILE</text>
          </g>
          {/* Google Sheets */}
          <g>
            ...
            <rect x="848" y="125" width="160" height="54" rx="6" fill="#141d2c" stroke="rgba(233,237,244,0.18)">
              {visible && <animate attributeName="stroke" begin="pk4.end" dur="1s" values="rgba(233,237,244,0.18);#7fd7e2;rgba(233,237,244,0.18)" keyTimes="0;0.3;1" />}
            </rect>
            <circle cx="868" cy="145" r="3.5" fill="#0F9D58" />
            <text x="882" y="150" fill="#e9edf4" fontSize="13.5" fontWeight="600" fontFamily="var(--font-inter), sans-serif">Google Sheets</text>
            <text x="868" y="168" fill="#8fa0b3" fontSize="9">THE FRIDAY REPORT</text>
          </g>
          ...
          <g opacity="0.5">
            ...
            <text x="848" y="256" fill="#8fa0b3" fontSize="9" letterSpacing="0.08em">BACK IN SANDRA&rsquo;S WEEK</text>
          </g>
          ...
          <defs>
            ...
            <linearGradient id="fadeL" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0" stopColor="#0c131e" />
              <stop offset="1" stopColor="#0c131e" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="fadeR" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0" stopColor="#0c131e" stopOpacity="0" />
              <stop offset="1" stopColor="#0c131e" />
            </linearGradient>
          </defs>
        </svg>
